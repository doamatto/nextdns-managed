...
- Icon URL: you should download the icon from their Twitter, their website, or you can embed to the one I kept here for personal usage (`https://ghcdn.rawgit.org/doamatto/nextdns-managed/master/logo.jpg`)
